...
pub const HELP_ENTRIES: &[HelpEntry] = &[
    ...
    HelpEntry { key: "mi", desc: "Switch to inbox mode", indent: true, todo_only: false, requires_claude: false, footer: None },
    HelpEntry { key: "ms", desc: "Switch to someday mode", indent: true, todo_only: false, requires_claude: false, footer: None },
    HelpEntry { key: "mw", desc: "Switch to waiting mode", indent: true, todo_only: false, requires_claude: false, footer: None },
